...
def main():
    ...
    for batch_size in args.batch_sizes:
        for learning_rate in args.learning_rates:
            train_dataloader = resttokenize(train_data, batch_size)
            dev_dataloader = resttokenize(dev_data, batch_size)
    ...
    test_dataloader = resttokenize(test_data, best_batch_size)
